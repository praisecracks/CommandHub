// components/delegate/ContactPickerModal.js
...
export default function ContactPickerModal({ visible, onClose, onSelect, title = 'Select Contact' }) {
...
// In ContactPickerModal.js, when loading contacts:
  ...
  try {
    ...
    const contactsData = snapshot.docs.map(doc => {
      ...
      return {
        ...
        phone: data.phone || '',
        system: data.system || '',
        role: data.role || '', // Ensure role is never undefined
  ...
  return (
    <Modal visible={visible} transparent animationType="slide">
      <View style={{ flex: 1, backgroundColor: 'rgba(0,0,0,0.7)', justifyContent: 'flex-end' }}>
        <View style={{ backgroundColor: '#111B21', borderTopLeftRadius: 28, borderTopRightRadius: 28, padding: 20, maxHeight: '80%' }}>
          ...
          {isLoading ? (
            <View style={{ padding: 40, alignItems: 'center' }}>
              ...
              <Text style={{ color: '#9CA3AF', marginTop: 12 }}>Loading contacts...</Text>
            </View>
          ) : (
            <FlatList
